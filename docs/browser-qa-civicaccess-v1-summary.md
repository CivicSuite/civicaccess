...
| Empty state | PASS - clearing title/text and running review renders actionable guidance for missing title/text/image context. |
| Error state | PASS - forced runtime failure path tells staff to check notice text and the service health endpoint; no public QA toggle is visible. |
